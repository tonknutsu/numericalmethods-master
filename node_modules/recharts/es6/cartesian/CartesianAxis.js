...
function (_Component) {
  ...
  _createClass(CartesianAxis, [{
    ...
    value: function renderAxisLine() {
      ...
      var props = _objectSpread({}, filterProps(this.props), {}, filterProps(axisLine), {
        fill: 'none'
      });
    ...
    value: function renderTicks(ticks) {
      ...
      var items = finalTicks.map(function (entry, i) {
        ...
        }, adaptEventsOfChild(_this.props, entry, i)), tickLine && React.createElement("line", _extends({
          className: "recharts-cartesian-axis-tick-line"
        }, tickLineProps, lineCoord)), tick && CartesianAxis.renderTickItem(tick, tickProps, "".concat(_isFunction(tickFormatter) ? tickFormatter(entry.value, i) : entry.value).concat(unit || '')));
      });
    ...
    value: function getTicksStart(_ref2, preserveEnd) {
      ...
      for (var _i = 0; _i < count; _i++) {
        var entry = result[_i];
        var content = _isFunction(tickFormatter) ? tickFormatter(entry.value, _i) : entry.value;
    ...
    value: function getTicksEnd(_ref3) {
      ...
      for (var _i2 = len - 1; _i2 >= 0; _i2--) {
        ...
        var content = _isFunction(tickFormatter) ? tickFormatter(entry.value, len - _i2 - 1) : entry.value;
        var size = getStringSize(content)[sizeKey] + unitSize;
