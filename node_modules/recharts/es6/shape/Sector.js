...
var getSectorWithCorner = function getSectorWithCorner(_ref3) {
  ...
  var outerArcAngle = cornerIsExternal ? Math.abs(startAngle - endAngle) + sot + eot : Math.abs(startAngle - endAngle) - sot - eot;
  ...
  if (innerRadius > 0) {
    ...
    var innerArcAngle = cornerIsExternal ? Math.abs(startAngle - endAngle) + sit + eit : Math.abs(startAngle - endAngle) - sit - eit;
...
function (_PureComponent) {
  ...
  _createClass(Sector, [{
    ...
    value: function render() {
      ...
      return React.createElement("path", _extends({}, filterProps(this.props, true), {
