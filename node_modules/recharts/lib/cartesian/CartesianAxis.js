...
function (_Component) {
  ...
  _createClass(CartesianAxis, [{
    ...
    value: function renderAxisLine() {
      ...
      var props = _objectSpread({}, (0, _types.filterProps)(this.props), {}, (0, _types.filterProps)(axisLine), {
        fill: 'none'
      });
    ...
    value: function renderTicks(ticks) {
      ...
      var items = finalTicks.map(function (entry, i) {
        ...
        }, tickLineProps, lineCoord)), tick && CartesianAxis.renderTickItem(tick, tickProps, "".concat((0, _isFunction2["default"])(tickFormatter) ? tickFormatter(entry.value, i) : entry.value).concat(unit || '')));
      });
    ...
    value: function getTicksStart(_ref2, preserveEnd) {
      ...
      for (var _i = 0; _i < count; _i++) {
        var entry = result[_i];
        var content = (0, _isFunction2["default"])(tickFormatter) ? tickFormatter(entry.value, _i) : entry.value;
    ...
    value: function getTicksEnd(_ref3) {
      ...
      for (var _i2 = len - 1; _i2 >= 0; _i2--) {
        ...
        var content = (0, _isFunction2["default"])(tickFormatter) ? tickFormatter(entry.value, len - _i2 - 1) : entry.value;
        var size = (0, _DOMUtils.getStringSize)(content)[sizeKey] + unitSize;
