...
class Bisection extends React.Component {
    constructor(props) {
        ...
        this.BisectionMethod=this.BisectionMethod.bind(this); //ประกาศฟังก์ชัน FalsePositionMethod
    }
    handleChange(event) {
    ...
    handleSubmit(event) {
        ...
        if((str.length!==0)&&(c!==0)&&this.state.submitted&&this.state.xl!==""&&this.state.xr!==""){ //เช็คความยาวสมการต้องไม่เท่ากับ 0 และ c ที่เช็ค x ต้องไม่เท่ากับ 0 และ xl xr ต้องไม่ใช่ค่าว่าง
          ...
          this.BisectionMethod(); //ส่งไปที่ฟังก์ชัน BisectionMethod
    ...
    BisectionMethod(event){
        ...
        Y=[];
          ...
          while(t){
            data.xm=(data.xl+data.xr)/2; //หา xm
